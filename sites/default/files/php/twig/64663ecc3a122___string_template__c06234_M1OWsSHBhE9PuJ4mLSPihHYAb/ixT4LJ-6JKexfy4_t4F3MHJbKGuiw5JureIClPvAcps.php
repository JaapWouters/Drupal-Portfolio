...
class __TwigTemplate_3ca00b3454be36850eaab870b386388c extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        return new Source("{# inline_template_start #}<div class=\"project-card\">
                <img class=\"card-image\" src=\"{{ field_media_image }}\" alt=\"\">
                <div class=\"card-text\">   
                    <h3>{{ title }}</h3>
                    <h4>{{ field_subtitle }}</h4>
                    <p>{{ field_intro }}</p>
                    <a href=\"{{ view_node }}\" class=\"btn btn-primary\">Learn more <i class=\"bi bi-arrow-right\"></i></a>
                </div>
            </div>", "__string_template__c06234ec231ab3afa80b2c092973769d", "");
    }
