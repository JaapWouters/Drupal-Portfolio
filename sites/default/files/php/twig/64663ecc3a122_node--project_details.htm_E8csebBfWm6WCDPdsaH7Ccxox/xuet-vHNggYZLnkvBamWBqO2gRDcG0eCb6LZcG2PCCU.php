                ...
                if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["paragraph"], "entity", [], "any", false, false, true, 37), "field_hidden", [], "any", false, false, true, 37), "value", [], "any", false, false, true, 37) == "1")) {
                    ...
                    if ((($context["paragraphType"] ?? null) == "cmd_method")) {
                        ...
                        if ((($context["type"] ?? null) != "other")) {
                            // line 48
                            echo "                        ";
                            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_striptags($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["paragraph"], "entity", [], "any", false, false, true, 48), "field_text", [], "any", false, false, true, 48), "value", [], "any", false, false, true, 48), 48, $this->source)), "html", null, true);
                            echo "
                            ";
                        }
                        // line 50
                ...
                <h3>CMD Methods</h3>
                    ...
                    {% else %}
                        ...
                        <div class=\"col-12 col-dot\">
                            ...
                            {% if type != 'other' %}
                        {{ paragraph.entity.field_text.value | raw | striptags}}
                            {% endif %}
                        </div>
                        {% endif %}
                    {% endif %}
